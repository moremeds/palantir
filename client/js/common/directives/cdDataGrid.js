...
angular.module("directives", []).
    directive("cdDatagrid", ["$compile", function ($compile) {
        ...
        return {
            restrict: "E",
            transclude: true,
            template: '<table class="uk-table uk-table-hover">\n' +
            ...
            controller: ["$scope", "$element", "$attrs", "$transclude", "$filter", "$timeout",
                function ($scope, $element, $attrs, $transclude, $filter, $timeout) {
                    var self = this;
                    $scope.columns = [];
