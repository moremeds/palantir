...
!function (a) {
    ...
    if (d.version = "2.8.0", d.$doc = g, d.$win = f, d.fn = function (a, c) {
            ...
            if (g.trigger("uk-domready"), setInterval(function () {
                    var a = {x: window.scrollX, y: window.scrollY}, c = function () {
                        (a.x != window.scrollX || a.y != window.scrollY) && (a = {
                            x: window.scrollX,
                            y: window.scrollY
    ...
    b.component("dropdown", {
        defaults: {mode: "hover", remaintime: 800, justify: !1, boundary: a(window), delay: 0},
        remainIdle: !1,
        init: function () {
            var e = this;
    ...
    var c = {
        x: window.scrollX,
        y: window.scrollY
    }, d = a(window), e = a(document), f = a("html"), g = {
        show: function (b) {
            if (b = a(b), b.length) {
                ...
                c = {x: window.scrollX, y: window.scrollY}, b.addClass("uk-active"), h.css({
            ...
            g.length && (a.UIkit.support.transition && !b ? (d.one(a.UIkit.support.transition.end, function () {
                d.removeClass("uk-offcanvas-page").css({
                    width: "",
                    height: ""
                }), g.removeClass("uk-active"), f.css("margin-top", ""), window.scrollTo(c.x, c.y)
            }).css(h ? "margin-right" : "margin-left", ""), setTimeout(function () {
                i.removeClass("uk-offcanvas-bar-show")
            }, 0)) : (d.removeClass("uk-offcanvas-page").css({
                width: "",
                height: ""
            }), g.removeClass("uk-active"), i.removeClass("uk-offcanvas-bar-show"), f.css("margin-top", ""), window.scrollTo(c.x, c.y)), g.off(".ukoffcanvas"), e.off(".ukoffcanvas"))
        }
    };
    ...
    b.component("tooltip", {
        defaults: {
            ...
            if (e && clearTimeout(e), this.tip.length) {
                ...
                var b = this, c = a("body").offset(), f = a.extend({}, this.element.offset(), {
                ...
                l.left -= a("body").position().left, e = setTimeout(function () {
                    d.css(l).attr("class", "uk-tooltip uk-tooltip-" + j), b.options.animation ? d.css({
                        opacity: 0,
                        display: "block"
    ...
    b.component("tab", {
        defaults: {connect: !1, active: 0}, init: function () {
            ...
            }), d.append(f).uk("dropdown", {mode: "click"}), this.element.append(d).data({
                dropdown: d.data("dropdown"),
                mobilecaption: e
